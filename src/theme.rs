...
pub fn apply_ios_style(ctx: &egui::Context) {
    ...
    style.visuals.widgets.inactive.rounding = Rounding::same(15.0);
    style.visuals.widgets.inactive.fg_stroke = egui::Stroke::new(1.0, Color32::from_rgb(0, 122, 255));
    
    style.spacing.item_spacing = Vec2::new(10.0, 20.0);
    style.spacing.button_padding = Vec2::new(25.0, 15.0);
